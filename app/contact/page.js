        ...
        <section className="w-[90%] relative overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center min-h-screen">
                <iframe
                    ...
                    width="1300"
                    height="760"
                    className="absolute top-0 left-20 w-[90%] h-[90%] border-0 rounded-xl"
                    allowFullScreen=""
                    loading="lazy"
            ...
            <div className="container px-5 py-24 mx-auto flex ">
                <div className="lg:w-[40%] md:w-1/2 bg-background  border-4 border-chart-2/50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
