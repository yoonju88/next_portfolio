...
export default function DesignList({ cover, name, type, link }) {
    return (
        <article className=" lg:min-w-[320px] lg:max-w-[340px] md:w-1/2 w-full p-4">
            <Link
                href={link}
            ...
            >
                ...
                <div className="px-8 py-24 relative rounded-lg text-center w-full max-h-[260px] z-10 bg-foreground/70 opacity-0 group-hover:opacity-100 group-hover:shadow-md group-hover:shadow-chart-1 group-hover:border-4 group-hover:border-chart-2">
