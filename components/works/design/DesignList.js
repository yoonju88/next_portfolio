...
export default function DesignList({ id, cover, name, type, link }) {
    return (
        <article className="lg:w-1/3 md:w-1/2 w-full p-4">
            <Link
                href={link}
                className="group flex relative rounded-lg overflow-hidden hover:shadow-lg hover:shadow-chart-1"
            >
                ...
                <div className="px-8 py-24 relative rounded-lg text-center z-10 w-full bg-foreground/70 opacity-0 group-hover:opacity-100">
