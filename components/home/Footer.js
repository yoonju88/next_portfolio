            ...
            <div className="flex items-center gap-5 sm:flex-row flex-col">
                ...
                <span className='inline-flex gap-4 sm:ml-auto mt-4 sm:mt-2 justify-center sm:justify-start'>
                    <ToolTip
                        text={t("linkedin")}
                    >
                        <Link href="https://www.linkedin.com/in/yoonju-t" target="_blank" title="LinkedIn">
                    ...
                    <ToolTip
                        text={t("github")}
                    >
                        <Link href="https://github.com/yoonju88" target="_blank" title="GitHub">
                    ...
                    <ToolTip
                        text={t("email")}
                    >
                        <Link href="mailto:hoyoonju2@gmail.com" target="_blank" title="E-Mail">
