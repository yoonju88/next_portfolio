        ...
        <section>
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-2/3 w-full mx-auto text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="inline-block w-8 h-8 text-foreground/80 hover:text-primary/80 mb-8" viewBox="0 0 975.036 975.036">
