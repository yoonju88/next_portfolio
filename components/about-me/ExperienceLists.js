    ...
    return (
        <div className=" group h-full flex items-start lg:flex-row md:flex-col sm:flex-col card-set-shadow">
            ...
            <div className="flex-grow lg:pl-7 md:pl-0 sm:pl-0">
                <h3 className="title-font text-base font-semibold mb-1 uppercase group-hover:text-white">
                    {jobTitle}
                </h3>
                <p className="tracking-widest text-xs title-font font-medium mb-1 group-hover:text-white">
                    <span className='pr-2'>
                        {companyName}
                    </span>
