    ...
    return (
        <section className="group flex flex-wrap items-center justify-center mt-14 py-10">
            ...
            <div className='lg:w-[70%] w-full pt-10 lg:pt-1 lg:text-left text-center'>
                <div className="flex items-center gap-2 lg:-mb-10 mb-6 lg:justify-end justify-center">
                    <ToolTip
                        text={t('link1')}
                        className={`${tooltipStyle} animate-scale-up-soft animate [animation-delay:700ms]`}
                    >
                ...
                <h3 className="sm:text-lg text-base font-semibold text-btn-1 mt-1 step-job animate-slide-down-soft [animation-delay:1100ms]">{t('job')}</h3>
                <div className=" relative mt-4 pt-4 sm:mt-0 text-center sm:text-left animate-slide-down-soft [animation-delay:1500ms]">
                    <p>{t('description')}</p>
