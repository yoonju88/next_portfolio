    ...
    return (
        <footer className="bg-secondary px-5 py-6 mx-auto">
            <div className="container flex items-center gap-5 sm:flex-row flex-col">
                <Link href="/">
                    <span className="text-xl text-foreground font-semibold">Yoonju.T </span>
                </Link>
                <p className='text-xs text-foreground flex items-center capitalize'>
                    © 2024 all rights reserved by TERRENOIRE Yoonju
                </p>
                <span className='inline-flex  gap-3 sm:ml-auto mt-4 sm:mt-0 justify-center sm:justify-start'>
                    <ToolTip
                        text="Go to LinkedIn"
                    ...
                    >
                        <MdAlternateEmail className='w-6 h-5' />
                    </ToolTip>
                </span>
            </div>
        </footer>
